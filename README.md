...
| T4     | Transaktion-Test          | Datenexfiltration durch Überwachung des Kommunikations-Kanal                                                                                               | Abfangen der Datenübertragung mittels Netzwerkmonitoring Tools                                                                 | Alle abgefangenen Dateien/Informationen befinden sich in einem verschlüsselten Zustand | :heavy_check_mark: |
...
| T7     | Unit-Tests/Manuelle Tests | Ausnutzung typischer Web-Schwachstellen wie CSRF oder XSS um unerlaubten Zugriff zu erhalten                                                               | Test-Eingaben, etc.                                                                                                            | Restriktives Verhalten der Anwendung ohne Daten preiszugeben                           | ---                |
| T8     | Unit-Test  /DDOS          | Ausfall der Datenbank auslösen                                                                                                                             | Durch erhöhte Anzahl an Anfragen Verbindung zur Datenbank kompromittieren                                                      | Ausfallzeit so gering wie möglich (optional auch restriktives Verhalten)               | ---                |
