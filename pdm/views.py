...
def download(request, doc_id):
    ...
    return StreamingHttpResponse(EncryptedFile(doc.file), content_type='application/octet-stream', headers={'Content-Disposition': 'attachment; filename=' + doc.name + '.' + doc.file.name.split('.')[-1]})
